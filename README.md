...
```scala
libraryDependencies += "com.github.xuwei-k" %% "msgpack4z-argonaut" % "0.3.0"
```

- [sxr](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/xuwei-k/msgpack4z-argonaut_2.11/0.3.0/msgpack4z-argonaut_2.11-0.3.0-sxr.jar/!/index.html)
