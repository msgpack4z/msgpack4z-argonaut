...
```scala
libraryDependencies += "com.github.xuwei-k" %% "msgpack4z-argonaut" % "0.7.1"
```

- [sxr](https://oss.sonatype.org/service/local/repositories/releases/archive/com/github/xuwei-k/msgpack4z-argonaut_2.11/0.7.1/msgpack4z-argonaut_2.11-0.7.1-sxr.jar/!/index.html)
